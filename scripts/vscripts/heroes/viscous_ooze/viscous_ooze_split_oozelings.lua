        ...
        Timers:CreateTimer(ability:GetCastPoint(), function() 
            ...
            table.foreach(points, function(k, v) 
                ...
                function(oozeling)
                    ...
                    caster:AddNewModifier(caster,ability,"modifier_split_oozeling_strength_modifier",{Duration = duration})
...
-- function modifier_split_oozeling_strength_modifier:OnCreated()
--     if IsServer() then 
    ...
    if not ooze:IsAlive() then
        ...
        if caster:HasScepter() then
            ...
            if slimeTrail and slimeTrail:GetLevel() > 0 then
                slimeTrail:CreateSlime(ooze:GetAbsOrigin(), radius)
            end
        end

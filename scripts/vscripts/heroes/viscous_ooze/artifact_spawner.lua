function SpawnOoze(keys)
	...
	local newHero = PlayerResource:ReplaceHeroWith(hero:GetPlayerOwnerID(), "npc_dota_hero_venomancer", PlayerResource:GetGold(hero:GetPlayerOwnerID()), hero:GetCurrentXP())	

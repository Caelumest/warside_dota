...
function modifier_sobek_link_of_fortitude_ally:OnCreated(params)
    ...
    self.caster_shield_particle = ParticleManager:CreateParticle("particles/items2_fx/medallion_of_courage_friend.vpcf", PATTACH_OVERHEAD_FOLLOW, self:GetCaster())
    ...
    self.parent_shield_particle = ParticleManager:CreateParticle("particles/items2_fx/medallion_of_courage_friend.vpcf", PATTACH_OVERHEAD_FOLLOW, self:GetParent())

...
function modifier_legion_demon_form:OnDestroy()
    if IsServer() then
        local target = self:GetParent()
...
function modifier_legion_demon_form:GetModifierModelChange()
...
function modifier_legion_demon_form:GetModifierHealthBonus()
